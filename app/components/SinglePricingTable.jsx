...
export default function SinglePricingTable() {
  ...
  return (
    <div className="bg-[#181818] py-24 sm:py-32" id="pricing-section">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl sm:text-center">
          <PageTitle
          id="pricing"
            className="text-center text-transparent bg-clip-text bg-gradient-to-b from-neutral-100 to-neutral-500 text-2xl !font-bold py-1 mx-auto"
            type="default"
          >
            {pricingData.title}
          </PageTitle>
        ...
        <div className="mx-auto mt-10 lg:mt-12 max-w-2xl rounded-3xl ring-1 ring-gray-700 lg:mx-0 lg:flex lg:max-w-none">
          <div className="p-8 sm:p-10 lg:flex-auto">
            <div className="mt-10 flex items-center gap-x-4">
              <h4 className="flex-none text-lg font-semibold leading-6 text-gray-300">
                What’s included
              </h4>
          ...
          <div className="p-2 lg:w-full lg:max-w-md lg:flex-shrink-0">
            <div className="rounded-2xl bg-white-900/20 py-10 text-center ring-1 ring-inset ring-gray-700 lg:flex lg:flex-col lg:justify-center lg:py-16">
