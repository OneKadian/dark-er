...
import imagery from "../public/MainGaphix.png";
...
export default function CallToAction() {
  ...
  return (
    <MotionBTTContainer transition={{ delay: 0.2, duration: 0.5 }}>
      <div className="bg-[#fffff14] py-24 lg:py-4">
        <div className=" ">
          {/* <BadgeGroup alignment="center">
                        <BadgeMessage>Call To Action</BadgeMessage>
                        <BadgeIcon icon="twemoji:money-bag" />
                    </BadgeGroup> */}
          <div className="relative overflow-hidden bg-[#fffff14] px-6 pt-16  sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
            {/* Text section */}
            <div className="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
              <h3 className="mb-4 text-3xl font-semibold text-transparent bg-clip-text bg-gradient-to-b from-neutral-100 to-neutral-500">
              ...
              <Content className="text-left text-gray-500">
